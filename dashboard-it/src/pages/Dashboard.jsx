...
function TaskJob(props) {
    ...
    <BootstrapDialog
      ...
      >
          ...
          {
             DataJobDetailJOB.length > 0 && DataJobDetailJOB[0].status === "pending"?
                <DialogActions>
                        <Button 
                            color="success"
                            sx={{
             ...
             :  
                DataJobDetailJOB.length > 0 && ( DataJobDetailJOB[0].status === "inprogress" ) ?
                ...
                :
                    DataJobDetailJOB.length > 0 && ( DataJobDetailJOB[0].status === "delay" ) ?
