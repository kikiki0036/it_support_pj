...
const Sidebar = props => {
    const sidebar_items = { 
        AccessRoleUSER :[
            ...
            },
            {
                ...
                "route": "/dashboard/notebook_center",
                "icon": "bx bx-desktop"
            }
        ],
        AccessRoleIT :[
    ...
    if(props.UserRole === "ROLE-IT-STAFF" || props.UserRole === "ROLE-IT-MANAGER" || props.UserRole === "ROLE-ADMIN") {
            ...
            <div className='sidebar__box'>
                ...
                <hr className="MuiDivider-root MuiDivider-fullWidth MuiDivider-light css-hr"/>
                {
                    props.UserRole !== "" ? 
                        ...
                        props.UserRole === "ROLE-IT-STAFF" || props.UserRole === "ROLE-IT-MANAGER" || props.UserRole === "ROLE-ADMIN" ?
